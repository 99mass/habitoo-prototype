...
export const ProNewPropertyForm = ({ 
  ...
  // Coordonnées de l'agent connecté
  const agentName = userProfile?.name || 'Jean-Marc Kouassi';
  const agentBadge = userProfile?.badgeText || 'Démarcheur Agréé PRO';
  ...
  // État du formulaire exactement aligné sur la maquette de référence
  const [formData, setFormData] = useState({
    category: 'LOCATION', // 'LOCATION' | 'VENTE'
    type: PROPERTY_TYPES[0] || 'Villas d\'architecte',
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      const newProperty = {
        ...
        price: `${Number(formData.price).toLocaleString('fr-FR')} FCFA${formData.category === 'LOCATION' ? '/mois' : ''}`,
        image: formData.images[0] || DEFAULT_IMAGES[0],
        specs: `${formData.bedrooms} ch. • ${formData.area} m²`,
    ...
    <div className="publish-process-card">
      ...
      {step === 1 && (
        <div className="publish-step-body animate-fadeIn">
          ...
          {/* Type de bien et Pays (Grille 2 colonnes comme sur la capture) */}
          ...
          <div className="compact-field">
            ...
            <textarea
              ...
              placeholder="Décrivez les atouts majeurs, les finitions et l'environnement..."
            />
          </div>
      ...
      {step === 2 && (
        <div className="publish-step-body animate-fadeIn">
          ...
          <div className="publish-grid-2">
            <div className="compact-field">
              <label className="compact-label">
                {formData.category === 'LOCATION' ? 'Loyer (FCFA/mois)' : 'Prix de vente (FCFA)'}
              </label>
              <div className="compact-affix-box">
                <input
                  ...
                  placeholder="3500000"
                />
                <span className="compact-affix-label">FCFA</span>
              </div>
              {errors.price && (
                <span style={{ fontSize: '0.68rem', color: 'var(--primary-red)', marginTop: '2px', display: 'block' }}>
                  {errors.price}
            ...
            <div className="compact-field">
              <label className="compact-label">Superficie habitable</label>
              <div className="compact-affix-box">
                <input
                  type="number"
                  className="compact-input"
          ...
          {/* Compteurs Chambres et Salles de bain */}
          <div className="publish-grid-2" style={{ marginBottom: '12px' }}>
            <div className="compact-field">
              ...
              <div className="compact-counter">
                ...
                <span className="counter-text">{formData.bedrooms}</span>
                <button
                  type="button"
                  className="counter-btn"
            ...
            <div className="compact-field">
              ...
              <div className="compact-counter">
                ...
                <span className="counter-text">{formData.bathrooms}</span>
                <button
                  type="button"
                  className="counter-btn"
          ...
          <div className="compact-field" style={{ marginTop: '12px' }}>
            ...
            <div className="pro-contact-locked-card">
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
                    <span style={{ fontSize: '0.82rem', fontWeight: 700, color: 'var(--obsidian-black)' }}>{agentName}</span>
                  </div>
              ...
              <p style={{ fontSize: '0.68rem', color: '#6B7280', margin: '8px 0 0', borderTop: '1px solid #F3F4F6', paddingTop: '6px' }}>
                Les demandes de visite et contacts acquéreurs seront directement redirigés vers ce numéro.
              </p>
            </div>
          </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '0.68rem', color: 'var(--graphite-gray)', margin: '2px 0 0' }}>
                    Propulse l'annonce en tête des résultats et en vitrine d'accueil.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="preview-carousel-card">
              <div className="preview-carousel-main-wrap">
                ...
                <div className="preview-carousel-badges">
                  ...
                  {formData.autoBoost && (
                    <span className="preview-badge-status" style={{ backgroundColor: '#FEF2F2', color: 'var(--primary-red)', borderColor: '#FECACA' }}>
                      <Zap size={11} style={{ marginRight: '3px' }} /> BOOSTÉ
                    </span>
                  )}
                </div>
                ...
                {/* Compteur d'images (comme sur la capture: 1 / 1 ou 1 / 4) */}
              ...
              <div className="preview-price-banner">
                <div>
                  ...
                  <div className="preview-price-val font-serif">
                    {Number(formData.price || 0).toLocaleString('fr-FR')} FCFA{formData.category === 'LOCATION' ? '/mois' : ''}
                  </div>
                </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                    ...
                    <span className="preview-owner-tag pro-badge">{agentBadge}</span>
                  </div>
                  <span className="preview-contact-caption">
                    WhatsApp direct : {formData.ownerPhone || agentPhoneDefault}
                  </span>
                </div>
              </div>
            </div>
